...
int sensorTipper1 = 26;
int sensorTipper2 = 27;
int sensorTipper3 = 28;
...
void setup() 
{
  ...
  pinMode(sensorTipper1, INPUT_PULLUP); // variables as input pullup
  pinMode(sensorTipper2, INPUT_PULLUP);
  pinMode(sensorTipper3, INPUT_PULLUP);
...
digitalWrite (Solenoid2,HIGH);
  ...
  digitalWrite (Tipper2Left,LOW);
    ...
    sensorTipper2 == 1;
  for (i=0;i<=230;i++){
      sensorTipper2 = digitalRead(sensorTipper2);
  Serial.println(sensorTipper2);
   if (sensorTipper2 == 0) {
   i=579;
   }
  }
...
digitalWrite (Solenoid3,HIGH);
  ...
  digitalWrite (Tipper3Left,LOW);
    ...
    sensorTipper3 == 1;         
  for (i=0;i<=230;i++){
      sensorTipper3 = digitalRead(sensorTipper3);
  Serial.println(sensorTipper3);
   if (sensorTipper3 == 0) {
   i=579;
   }
  }
