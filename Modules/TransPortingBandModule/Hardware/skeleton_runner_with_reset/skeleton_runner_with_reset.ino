...
void runnerWok() { // Subrutine for move the runner to wok 1
  Serial.println("moviendo runner");

  digitalWrite(ADRESS, LOW); // define the actual position of runner
  for (j = 0; j < 1; j++) {
  ...
  //}
  Serial.print("rutina de Wok, runnerWok");
  Serial.println(w);
...
void releasingStateActions() {
  ...
  Serial.println("salsa, releasingStateActions");
  delay(2000);
...
void retrievingStateActions() {
  ...
  Serial.println("retornando, retrievingStateActions");
